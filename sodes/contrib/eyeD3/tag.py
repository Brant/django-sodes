...
import mimetypes;
from stat import *;
from sodes.contrib.eyeD3 import *;
import sodes.contrib.eyeD3.utils;
import sodes.contrib.eyeD3.mp3;
from sodes.contrib.eyeD3.frames import *;
from sodes.contrib.eyeD3.binfuncs import *;
import math;
...
class TagFile:
   ...
   def getPlayTimeString(self):
      from sodes.contrib.eyeD3.utils import format_track_time
